...
input_joined_EB_WH_AB <- dplyr::full_join(input_joined_EB_WH, input_InLab_AB, c("category_in_Ayinde_Best_template" = "Morphotype DSR"))
# note that AB columns are type chr
