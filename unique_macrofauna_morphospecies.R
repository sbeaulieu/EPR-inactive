...
# load data
full_data <- read_excel("TEMPLATE_unique_macrofauna_morphospecies_2026-08-03.xlsx", skip = 3)
...
Appendix_uniq_morph <- dplyr::select(uniq_morph, "Table of Contents", morphospecies, kingdom, phylum, class, order, family)
# ultimately decided to not include identificationRemarks in Appendix

# save output Appendix file
#readr::write_csv(Appendix_uniq_morph, "Appendix_uniq_morph_2026-08-03.csv", na = "")
...
#readr::write_csv(for_bcodmo, "BCO-DMO_macrofauna_morphospecies_2026-08-03.csv", na = "")
